...
public class UserController {
    ...
    // One user can join 1 room
    @PutMapping(value = "user/{user_id}/room/{room_id}")
    public ResponseEntity<String> joinRoom (@PathVariable("user_id") Long user_id, @PathVariable("room_id") Long room_id) throws Exception {
        return ResponseEntity.ok(userService.joinRoom(user_id, room_id));
    }
    // Update User
