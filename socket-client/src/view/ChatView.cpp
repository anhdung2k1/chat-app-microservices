...
//    string content;
//    if(message.getSender().getName() != currentUser.getName()) {
//       content = message.getSender().getName() + ": " + message.getText();
//       mvwaddstr(win, y, 3, content.c_str());
//    }
//    else {
//       mvwaddstr(win, y, win->_maxx - message.getText().length() - 3, message.getText().c_str());
//    }
// }
